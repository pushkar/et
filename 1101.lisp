...
(expense (payer post) (value 3) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 28.25) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 68.45) (splits pushkar jon shauvik)) ;; sewer
(payment (from jon) (to post) (value 1623.70))

;; 1/16/12 gapower electric bill
(expense (payer jon) (value 97.98) (splits jon pushkar shauvik))
;; 1/16/12 infinite energy gas bill
(expense (payer jon) (value 143.33) (splits jon pushkar shauvik))
;; 1/13/12 renter insurance
(expense (payer jon) (value 19.83) (splits jon pushkar shauvik))
;; 2/4/12 comcast
(expense (payer jon) (value 42.55) (splits jon pushkar shauvik))
...
(expense (payer post) (value 3) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 31.61) (splits pushkar jon shauvik)) ;; water
...
;; 5/10/12 gapower electric bill
(expense (payer jon) (value 87.15) (splits jon pushkar shauvik))
;; 5/10/12 infinite energy gas bill
(expense (payer jon) (value 46.90) (splits jon pushkar shauvik))
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 30.28) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 75.26) (splits pushkar jon shauvik)) ;; sewer

;; 6/1/12
(payment (from jon) (to pushkar) (value 650.00))
(payment (from pushkar) (to post) (value 1738.04))

;; 6/10/12 gapower electric bill
(expense (payer jon) (value 122.58) (splits jon pushkar shauvik))
;; 6/10/12 infinite energy gas bill
(expense (payer jon) (value 44.10) (splits jon pushkar shauvik))
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 31.09) (splits pushkar jon shauvik)) ;; water
...
;; 8/11/12 gapower electric bill
(expense (payer jon) (value 233.30) (splits jon pushkar shauvik))
;; 8/11/12 infinite energy gas bill
(expense (payer jon) (value 39.36) (splits jon pushkar shauvik))
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 26.23) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 65.47) (splits pushkar jon shauvik)) ;; sewer
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 36.13) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 85.91) (splits pushkar jon shauvik)) ;; sewer
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 126.63) (splits pushkar jon shauvik)) ;; water + sewer

(payment (from shauvik) (to jon) (value 1600.00))
(payment (from jon) (to post) (value 1759.13))

;; 12/13/12 gapower electric bill
(expense (payer jon) (value 57.20) (splits jon pushkar shauvik))
;; 12/13/12 infinite energy gas bill
(expense (payer jon) (value 135.30) (splits jon pushkar shauvik))
;; 12/11/12 renter insurance
(expense (payer jon) (value 19.83) (splits jon pushkar shauvik))
;; 12/06/12 comcast
(expense (payer jon) (value 39.99) (splits jon pushkar shauvik))

;; 12/03/12 paypal transfer
(payment (from pushkar) (to jon) (value 381.38))

;; Jan 2013 Rent
(expense (payer post) (value 1625) (splits (pushkar .30) (jon .333) (shauvik .367)))
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 17.33) (splits pushkar jon shauvik)) ;; water
...
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 38.72) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 90.41) (splits pushkar jon shauvik)) ;; sewer

(payment (from pushkar) (to post) (value 1761.63))

;; 6/15/13 gapower electric bill
(expense (payer jon) (value 79.68) (splits jon pushkar shauvik))
;; 6/15/13 infinite energy gas bill
(expense (payer jon) (value 73.84) (splits jon pushkar shauvik))
...
(payment (from pushkar) (to shauvik) (value 67.04))

;; July 2013 Rent
(expense (payer post) (value 1625) (splits (pushkar .30) (jon .333) (shauvik .367)))
(expense (payer post) (value 3.5) (splits pushkar jon shauvik)) ;; trash
(expense (payer post) (value 4) (splits pushkar jon shauvik)) ;; admin
(expense (payer post) (value 27.96) (splits pushkar jon shauvik)) ;; water
(expense (payer post) (value 65.29) (splits pushkar jon shauvik)) ;; sewer
